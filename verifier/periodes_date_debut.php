<?php
/**
 * API de vérification : vérification de la validité de la date_debut 'une période
 *
 ...
 */
function verifier_periodes_date_debut_dist($valeur, $options) {
	include_spip('inc/objets_restrictions_periodes');
	return periodes_verifier_date('date_debut', $valeur, $options);
}
